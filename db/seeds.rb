...
item_1 = Item.create!(name: "Anime Stickers", description: "Random One Piece and Death Note stickers", unit_price: 300, merchant_id: nomi.id)
...
invoice_items_1 = InvoiceItem.create!(item_id: item_1.id, invoice_id: invoice_1.id, quantity: 10, unit_price: 300, status: "shipped", created_at: Time.parse("22.11.02"))
...
discount_10off = BulkDiscount.create!(name: "10 off for 10 items", threshold: 10, percentage_discount: 10, merchant_id: nomi.id)
discount_20off = BulkDiscount.create!(name: "10 off for 10 items", threshold: 10, percentage_discount: 20, merchant_id: nomi.id)